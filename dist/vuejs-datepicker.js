...
(function (global, factory) {
  ...
  var utils = {
     ...
     * @return {Date}
     */
    getNewDateObject: function getNewDateObject () {
      var d = new Date();
      ...
      days: function days () {
        ...
        for (var i = 0; i < daysInMonth; i++) {
          days.push({
            ...
            isToday: this$1.utils.compareDates(dObj, this$1.utils.getNewDateObject()),
